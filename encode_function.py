...
def encode(a,b,c):
    args1= {      
        ...
        'dlatent_dir':c,
        'average_best_loss':0.25,'batch_size':1,'clipping_threshold':2.0,
    'composite_blur':8,'composite_mask':True,'data_dir':'data','decay_rate':0.9,
    'decay_steps':24.0,'dlatent_avg':'','early_stopping':True,
    'early_stopping_patience':10,'early_stopping_threshold':0.5,'face_mask':False,
    'image_size':256,'iterations':600,
    'load_effnet':'data/finetuned_effnet.h5','load_last':'','load_mask':False,
    'load_resnet':'data/finetuned_resnet.h5','lr':0.35,'mask_dir':'masks',
    'model_res':1024,'model_url':'gdrive:networks/stylegan2-ffhq-config-f.pkl',
    'optimizer':'ggt','output_video':False,'randomize_noise':False,
    'resnet_image_size':256,'scale_mask':1.4,'sharpen_input':True,
    'tile_dlatents':False,'use_adaptive_loss':False,'use_best_loss':True,
    'use_discriminator_loss':0.5,'use_grabcut':True,'use_l1_penalty':0.5,
    'use_lpips_loss':100,'use_mssim_loss':200,'use_pixel_loss':1.5,
    'use_preprocess_input':True,'use_vgg_layer':9,'use_vgg_loss':0.4,
    'vgg_url':'https://rolux.org/media/stylegan/vgg16_zhang_perceptual.pkl',
    'video_codec':'MJPG',
    'video_dir':'videos','video_frame_rate':24,'video_size':512,'video_skip':1}
    class Struct:
